...
def calculate_risk_thresholds(
    ...
    """Calculate risk thresholds from historical model predictions."""

    low_threshold = historical_predictions.quantile(
        0.33
    )

    high_threshold = historical_predictions.quantile(
        0.67
    )
